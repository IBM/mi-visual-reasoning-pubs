...
\begin{figure}[b!]
	\centering
	\includegraphics[width=0.8\textwidth]{../img/plots/clevr_baselines.pdf}
...
\begin{figure}[b!]
	\centering
	\includegraphics[width=\textwidth]{../img/architecture/hierarchy}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=\textwidth]{../img/plots/cog_temporal_transfer_baselines.pdf}
