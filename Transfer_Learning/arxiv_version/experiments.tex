...
Supplementary information regarding the dataset parameters and experiments can be found in the appendix.
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.9\textwidth]{../img/plots/cog_temporal_transfer_baselines.pdf}
