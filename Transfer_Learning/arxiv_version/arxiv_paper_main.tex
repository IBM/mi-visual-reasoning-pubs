...
\title{Transfer Learning in Visual and Relational Reasoning\footnote{%
		This work was primarily done at IBM Research AI.}}

%%%%%%%%% AUTHORS
% WILL NEED TO REARRANGE THE AUTHORS LIST & GET CORRECT INSTITUTIONS / EMAILS
\author{%
	T.S. Jayram\thanks{IBM Research AI. \textit{Almaden Research Center, San Jose, CA, USA}.} \and  
	Vincent Marois\thanks{IBM Research AI. \textit{Thomas J. Watson Research Center, Yorktown Heights, NY, USA}.} \and 
	Tomasz Kornuta\thanks{Nvidia Research. \textit{Santa Clara, CA, USA}.} \and 
