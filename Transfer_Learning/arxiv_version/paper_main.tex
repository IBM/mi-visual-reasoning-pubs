...
%%%%%%%%% TITLE
\title{Transfer Learning in Visual and Relational Reasoning\footnote{%
		Major portion of this work was done when all the authors were at IBM Research AI (Almaden)}}

%%%%%%%%% AUTHORS
% WILL NEED TO REARRANGE THE AUTHORS LIST & GET CORRECT INSTITUTIONS / EMAILS
\author{%
	T.S. Jayram\thanks{IBM Research AI.
		Location: \textit{Almaden Research Center, San Jose, CA, USA}.} \and  
	Vincent Marois\thanks{IBM Research AI. 
		Location: \textit{Thomas J. Watson Research Center, Yorktown Heights, NY, USA}.} \and 
	Tomasz Kornuta\thanks{Nvidia Research. 
		Location: \textit{Santa Clara, CA, USA}.} \and 
	Vincent Albouy\thanks{} \and 
	Emre Sevgen\thanks{University of Chicago.}  \and 
