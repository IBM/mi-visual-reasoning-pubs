...
\author{%
	T.S. Jayram\thanks{IBM Research AI.
		\textit{Location}: Almaden Research Center, San Jose, CA, USA.} \and  
	Vincent Marois\thanks{IBM Research AI. 
		\textit{Location}: Thomas J. Watson Research Center, Yorktown Heights, NY, USA.} \and 
	Tomasz Kornuta\thanks{Nvidia Research. 
		\textit{Location}: Santa Clara, CA, USA.
		Work done while employed at IBM Research AI.} \and 
	Vincent Albouy  \and 
	Emre Sevgen \and 
	Ahmet Ozcan\footnotemark[1]
}
