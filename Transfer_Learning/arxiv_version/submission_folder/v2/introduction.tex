...
In particular, \cite{johnson2017clevr} introduces the CLEVR dataset along with two variants (CoGenT-A and -B) with varying combinations of visual attributes.
