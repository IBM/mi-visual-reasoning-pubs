...
%	\centering
%	\includegraphics[width=\textwidth]{figures/samnet_architecture4}
%\end{minipage}\hfill
%\begin{minipage}{0.55\textwidth}
%	\centering
%	\includegraphics[width=\textwidth]{figures/samcell_reasoning}
%\end{minipage}\hfill
...
\begin{figure*}[htbp]
	\centering
	\includegraphics[width=0.9\textwidth]{figures/transfer_taxo}
