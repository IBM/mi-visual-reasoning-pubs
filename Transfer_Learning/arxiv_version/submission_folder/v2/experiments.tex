...
Additional information regarding the dataset parameters 
can be found in~\cref{sec:datasets-desc}.
...
\begin{figure}[hbtp]
	\centering
	\includegraphics[width=0.5\textwidth]{figures/clevr_baselines.pdf}
...
We compared our results with the baseline model introduced in~\cite{yang2018dataset}, the same paper as the COG dataset.
The most important results are highlighted in~\cref{fig:samnet_cog_detailed}; full comparison can be found in~\cref{sec:cog-all-results}.

\begin{figure}[htbp]
	\centering
	\begin{subfigure}{\textwidth}
		\centering
		\includegraphics[width=\textwidth]{figures/cog_canonical_baseline_no_labels.pdf}
	\end{subfigure}%
	\newline
	\begin{subfigure}{\textwidth}
		\centering
		\includegraphics[width=\textwidth]{figures/cog_hard_baseline_labels.pdf}
	\end{subfigure}%
...
We also consider a direct test on CoGenT-A; and a test on CoGenT-A after fine-tuning on CoGenT-B.

\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.9\textwidth]{figures/cogent_feature_transfer_baselines.pdf}
...
\begin{figure}[b!]
	\centering
	\includegraphics[width=0.8\textwidth]{figures/cog_temporal_transfer_baselines.pdf}
