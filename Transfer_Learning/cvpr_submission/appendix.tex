...
\centering
	...
	\begin{tabular}{lcccccccccc}
		...
		\end{tabular}
		\end{adjustbox}
	\caption{COG test set accuracies for SAMNet and baseline model~\cite{yang2018dataset}. Below `paper' denotes results from~\cite{yang2018dataset} with further author clarifications (private communication) while `code' denotes results of our experiments using their implementation~\cite{yang2018implement}.}
