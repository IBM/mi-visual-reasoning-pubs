...
We compare our model to the original COG model and show that SAMNet outperforms the original COG baseline model especially on the hardest version of the dataset with longer sequences and a maximum number of distractors.
