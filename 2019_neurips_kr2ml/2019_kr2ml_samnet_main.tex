...
We compare our model to the original COG model and show that SAMNet outperforms the original COG basline model especially on the hardest version of the dataset with longer sequences and a maximum number of distractors.
...
The authors would like to thank to the authors of COG paper (Igor Ganichev in particular) for sharing the detailed performances achieved by their COG baseline model.
