...
Along with CLEVR, the authors~\cite{hudson2018compositional} introduced  CLEVR-CoGenT (Compositional Generalization Test, CoGenT in short), with a goal of evaluating how well the models can generalize, learn relations and compositional concepts.
...
\bibliography{vigil_bibliograph}
}
