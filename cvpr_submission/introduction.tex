...
\vm{I think the contributions should be: 1. A new model with SotA results on COG |  2. transfer  / multitask learning  in COG | 3.  transfer  / multitask learning  in CLEVR | 4. Ablation study ("all-but-one") in CLEVR and the limitations of transfer learning (e.g. the labels domains should be aligned)}.
