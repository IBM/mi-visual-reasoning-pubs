...
and in particular, transfer learning for visual reasoning tasks that have a ``nice'' logical structure, e.g., 
see~\cite{johnson2017clevr,yang2018dataset,song2018explore}. 
...
(\cref{sec:feature}).
In this case, training on the first dataset might yield entangled feature representations that may fail reasoning tasks
...
transfer over to longer sequences, e.g., the Canonical and the Hard variants of the 
