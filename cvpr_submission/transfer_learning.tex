...
\begin{definition}[\cite{pan-yang}] \label{defn:transfer}
...
Although~\cref{defn:transfer} is quite general, it does not adequately capture all the artifacts present in the visual reasoning.
