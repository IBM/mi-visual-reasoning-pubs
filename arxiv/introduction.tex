...
Additionally, in \sec{failures} we present examples that support our hypotheses on lack of disentanglement of concepts in both models.
\sec{comparison} presents 
