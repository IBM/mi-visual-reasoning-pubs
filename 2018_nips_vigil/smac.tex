...
Our experiments demonstrate that this gives us noticeable savings in the training time. However, since the computation time is also dominated by the position-aware layers in the Control Unit as well as the input unit so the speedup is not as large as we desire.