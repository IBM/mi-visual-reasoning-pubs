...
\begin{table}[]
	...
	\begin{tabular}{ccccCcCc}
		...
		\midrule
		\multirow{10}{*}{MAC} & \multirow{4}{*}{CLEVR}  & \multirow{4}{*}{30:52}  & \multirow{4}{*}{96.70} & \multirow{4}{*}{--}   & \multirow{4}{*}{--}  & CLEVR    & 96.17          \\
		\cmidrule{7-8} 
		 &                        &  &               &     &                                & CoGenT-A    &  96.22   \\
		\cmidrule{7-8} 
		  &                        &   &              &     &                               & CoGenT-B   & 96.27  \\
		...
		&                             &                                         &       &         &                & CoGenT-B &    95.62       \\
		\midrule
		\multirow{10}{*}{S-MAC} & \multirow{3}{*}{CLEVR}  & \multirow{3}{*}{28:30}  & \multirow{3}{*}{95.82} & \multirow{3}{*}{--}   & \multirow{3}{*}{--}  & CLEVR    & 95.29           \\
		\cmidrule{7-8} 
		&                        &  &               &     &                                & CoGenT-A    &  95.47   \\
		\cmidrule{7-8} 
		&                        &   &              &     &                               & CoGenT-B   &  95.58  \\		
