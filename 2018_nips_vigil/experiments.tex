...
\begin{table}[]
	...
	\begin{tabular}{ccccCcCc}
		...
		\midrule
		\multirow{3}{*}{MAC}  & CLEVR                       & 31.86         &  --   & --                     & 96.7                  & CLEVR    & 96.2          \\
		\cmidrule{2-4} \cmidrule{5-6} \cmidrule{7-8} 
		& \multirow{2}{*}{CoGenT-A} & \multirow{2}{*}{31.86}     &  \multirow{2}{*}{--}  &  \multirow{2}{*}{--}    & \multirow{2}{*}{97.0} & CoGenT-A & 96.9         \\
		\cmidrule{7-8} 
		&                             &                                         &       &         &                & CoGenT-B & 79.5          \\
		\midrule
		\multirow{3}{*}{SMAC} & CLEVR                       & 28.51      &   --   &   --                 & 95.8               & CLEVR    & 95.3          \\
		\cmidrule{2-4} \cmidrule{5-6} \cmidrule{7-8} 
		& \multirow{2}{*}{CoGenT-A}   & \multirow{2}{*}{28.55}  &  \multirow{2}{*}{--}  &  \multirow{2}{*}{--}    & \multirow{2}{*}{96.1} & CoGenT-A & 95.9          \\
		\cmidrule{7-8} 
		&                             &                                         &     &          &                & CogenT-B & 78.7          \\
		\bottomrule
	\end{tabular}
