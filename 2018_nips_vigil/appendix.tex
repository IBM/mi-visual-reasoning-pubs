...
In \tableref{tab:results_full}, we present the full comparison table between MAC and S-MAC models.
...
\begin{table}[!h]
	...
	\begin{tabular}{cCcCcCc}
		\toprule
		Model & \multicolumn{2}{c}{Training} &    \multicolumn{2}{c}{Fine-tuning} &   \multicolumn{2}{c}{Test} & \multirow{2}{*}{Row} \\
		\cmidrule{2-3} \cmidrule{4-5}\cmidrule{6-7}\cmidrule{7-8} 
...
The authors compare the accuracy of their model tested on CLEVR, alongside with several existing models, including the previously mentioned PG + EE, CNN + GRU + FiLM \& MAC, and show improvement.
